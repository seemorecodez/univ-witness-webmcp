...
let gen = (function* _initGenerator () {
  ...
  const _trampoline12 = function(arg0) {
    _debugLog('[iface="wasi:cli/environment@0.2.6", function="get-arguments"] [Instruction::CallInterface] (sync, @ enter)');
    let hostProvided = true;
  ...
  _trampoline12.fnName = 'wasi:cli/environment@0.2.6#getArguments';
...
_trampoline13.fnName = 'wasi:io/streams@0.2.6#checkWrite';
...
_trampoline14.fnName = 'wasi:io/streams@0.2.6#write';
...
_trampoline15.fnName = 'wasi:io/streams@0.2.6#blockingFlush';
...
_trampoline16.fnName = 'wasi:cli/environment@0.2.6#getEnvironment';
...
_trampoline17.fnName = 'wasi:cli/terminal-stdin@0.2.6#getTerminalStdin';
...
_trampoline18.fnName = 'wasi:cli/terminal-stdout@0.2.6#getTerminalStdout';
...
_trampoline19.fnName = 'wasi:cli/terminal-stderr@0.2.6#getTerminalStderr';
let exports2;
let run020Run;
